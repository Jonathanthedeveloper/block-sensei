...
let AuthService = class AuthService {
    ...
    suiService;
    configService;
    constructor(prisma, jwtService, suiService, configService) {
        this.prisma = prisma;
    ...
    async getCurrentUser(userId) {
        ...
        const balance = await this.suiService.getTokenBalance(user?.wallet_address, this.configService.get('TOKEN_ADDRESS'));

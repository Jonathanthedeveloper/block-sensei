        ...
        imports: [
            ...
            config_1.ConfigModule.forRoot({
                ...
                validationSchema: joi_1.default.object({
                    ...
                    SUI_PACKAGE_ID: joi_1.default.string().required(),
                    SUI_ADMIN_CAPABILITY_ID: joi_1.default.string().required(),
                    SUI_TREASURY_CAPALITY_ID: joi_1.default.string().required(),

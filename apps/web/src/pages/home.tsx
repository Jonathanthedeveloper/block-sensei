...
import suiSrc from "@/assets/sui.svg";
...
export default function Home() {
  ...
  return (
    <div
      className="h-[400vh] bg-[#020202] w-full dark:border-white/[0.1] rounded-md relative overflow-clip"
      ref={ref}
    >
      {" "}
      ...
      <div className={cn("sticky top-40 z-20")}>
        ...
        <p className="text-xs md:text-xl font-normal text-center text-neutral-400 mt-4 max-w-lg mx-auto">
          ...
          learning experience that simplifies Web3 and rewards learners by
          letting them earn in Web 3 while learning.
        </p>
        <div className="w-full h-[930px] -top-60 md:-top-40  flex items-center justify-center bg-red-transparent absolute">
          <button className="font-bold bg-white rounded-full md:px-4 md:py-2 px-2 py-1 md:mt-24 mt-8 z-30 md:text-base text-black text-xs  w-fit mx-auto flex items-center gap-2 border-ruddy-blue">
            <img src={suiSrc} />
            Built on sui
          </button>
        </div>
